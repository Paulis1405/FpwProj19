...
<html>
    ...
    <body>
        ...
        <div id="GIU">
            ...
            <aside>
                    <h3>Peer Review:</h3>
                    <p>Nell'ambito della ricerca scientifica, la procedura di valutazione e di selezione degli articoli
                      o dei progetti di ricerca effettuata da specialisti del settore per verificarne l'idoneità alla 
                      pubblicazione o al finanziamento.</p>
            </aside>
            </div>
                <div class="col-9 col-s-9">
                <main>
                <h2 id="login">LOGIN</h2>
                <form id="log" action="articoli.html" method="post">
                
                <label for="email">Email </label>
                <input type="email" name="email" id="email" value="marrioverdi@peerrewiew.it" />
                <br>
                <label for="id_password">Password </label>
                <input type="password" name="password” " id="id_password" value="oscurato" />
                <br>
                <input id="accesso" type="submit" value="Accedi"/>
                <br><br>
